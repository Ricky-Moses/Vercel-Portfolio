...
const AboutEdEx = () => {
    return (
        <section className="about-ed grid place-items-center gap-6 !p-3">
            <div className="">
            ...
            <div className="w-11/12 md:w-3/4 grid lg:grid-cols-2 gap-8 place-items-center ">
                {AboutMe?.map(({ Icon, year, studies, place, desc }, idx) => (
                    <div
                        key={idx}
                        className="w-full h-full flex gap-2 border-l border-gray-500">
